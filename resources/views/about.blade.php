    ...
    <div class="container mb-5">
      <div class="row rounded flex-column align-items-center" style="background-color: #D9D9D9; color:black;">
        <div class="col-md-4 text-center mb-4">
          ...
          <img src="img/8.jpg" class="rounded mx-auto d-block mb-3 img-fluid" alt="Rektor">
        </div>
        <div class="col-md-4 text-center mb-4">
          <h5 class="py-3">Wakil Rektor <br> Bidang Akademik</h5>
          <img src="img/6.jpg" class="rounded mx-auto d-block mb-3 img-fluid" alt="Wakil Rektor">
        </div>
