...
<body>
  ...
  <section style="background-image: url('img/gedung.jpg'); background-size: cover; background-position: center; height: 100%;">
    <div class=" h-100">
      <div class="idx text-center d-flex flex-column justify-content-center align-items-center" style="background: rgba(255, 255, 255, 0.8); backdrop-filter: blur(10px); padding: 20px; height: 100%;">
        ...
        <p class="content-paragraph mx-3 mx-md-5" style="font-size: large;">
          Dengan berbagai usaha dan lika liku pengurusan ijin serta doa, maka pada tanggal 10 Agustus 2002 keluarlah ijin dimaksud dengan nomor 157/D/O/2002 dengan 2 jurusan / program studi yakni Sistem Komputer (jenjang S1) dan Manajemen Informatika (jenjang D3) lalu pada tahun 2009 ada tambahan program studi baru yakni Sistem Informasi (jenjang S1).
        </p>
        <p class="content-paragraph mx-3 mx-md-5" style="font-size: large;">
  ...
  <!-- visi misi tujuan -->
  <section id="visi-misi" class="text-light position-relative" style="background-color: #0B1D6F; position: relative;">
    ...
    <div class="container py-5">
      ...
      <p>Menjadi penyelenggara program Pascasarjana yang berkualitas dan berdaya saing internasional dalam pengembangan bidang ilmu Pengetahuan, Teknologi dan Seni</p>
      <div>
        <h3>Misi</h3>
        <p>
          ...
          3. Memberikan manfaat yang sebesar-besarnya kepada masyarakat sekitar, regional dan nasional terkait dengan pengembangan dan aplikasi bidang ilmu pengetahuan, teknologi dan seni. <br>
          4. Menjalin kerjasama dengan berbagai kalangan baik dalam maupun luar negeri dalam rangka pengembangan dan peningkatan kualitas ITB STIKOM Bali. <br>
          5. Menjadi wadah yang dapat dibanggakan dan memberikan rasa nyaman bagi seluruh warga kampus. <br>
          6. Melaksanakan pengelolaan institusi dengan memerhatikan prinsip-prinsip tata pamong dan tata kelola yang baik (transparansi, akuntabilitas, bertanggungjawab, mandiri, dan berkeadilan).
        </p>
      </div>
      <h3>Tujuan</h3>
      <p>
        1. Meningkatkan kualitas dan relevansi pendidikan di bidang ICT. <br>
        2. Meningkatkan kualitas dan kuantitas penelitian dan pengabdian kepada masyarakat di bidang ICT. <br>
        3. Menumbuhkan sikap toleransi, kemampuan kerjasama, semangat kepribadian bangsa, serta mengembangkan disiplin di kalangan civitas akademika dan masyarakat. <br>
  ...
  <section id="" class="text-light position-relative" style="background-color: #0B1D6F; position: relative;">
    ...
    <div class="container mb-5 pt-5">
      <div class="row rounded flex-column align-items-center" style="background-color: #D9D9D9; color:black;">
        <div class="col-md-4 text-center mb-4">
          <h5 class="py-3">Rektor</h5>
          <img src="img/image 11.png" class="rounded mx-auto d-block mb-3 img-fluid" alt="Rektor">
        </div>
        <div class="col-md-4 text-center mb-4">
          <h5 class="py-3">Wakil Rektor <br> Bidang Akademik</h5>
          <img src="img/image 12.png" class="rounded mx-auto d-block mb-3 img-fluid" alt="Wakil Rektor">
        </div>
        <div class="col-md-4 text-center">
          <h5 class="py-3">Direktur Pascasarjana</h5>
          <img src="img/image 13.png" class="rounded mx-auto d-block mb-3 img-fluid" alt="Direktur Pascasarjana">
        </div>

        <div class="row align-items-center py-5">
          <div class="col-md-4 text-center mb-4 mb-md-0">
            <h5 class="py-3">Sekretaris Prodi Magister Sistem Informasi</h5>
            <img src="img/image 14.png" class="rounded mx-auto d-block img-fluid" alt="Foto 1">
          </div>
          <div class="col-md-4 text-center mb-4 mb-md-0">
            <h5 class="py-3">Koordinator AkademikPascasarjana</h5>
            <img src="img/image 15.png" class="rounded mx-auto d-block img-fluid" alt="Foto 2">
          </div>
          <div class="col-md-4 text-center">
            <h5 class="py-3">Koordinator SPMI Pascasarjana</h5>
            <img src="img/image 16.png" class="rounded mx-auto d-block img-fluid" alt="Foto 3">
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container">
    <div class="img-container">
      <div class="img-wrapper">
        <img src="img/dosen1.png" alt="Dosen 1">
        <span class="img-name">Prof. Dr. I Made Bandem</span>
      </div>
      <div class="img-wrapper">
        <img src="img/dosen2.png" alt="Dosen 2">
        <span class="img-name">Dr. Dadang Hermawan</span>
      </div>
      <div class="img-wrapper">
        <img src="img/dosen3.png" alt="Dosen 3">
        <span class="img-name">Dr. Roy Rudolf Huizen, S.T., M.T</span>
      </div>
      <div class="img-wrapper">
        <img src="img/dosen4.png" alt="Dosen 4">
        <span class="img-name">Dr. Dandy Pramana Hostiadi, S.Kom., M.T</span>
      </div>
    </div>
    <div class="img-container">
      <div class="img-wrapper">
        <img src="img/dosen5.png" alt="Dosen 5">
        <span class="img-name">Dr. Putri Srinadi, S.E, M.M.Kom</span>
      </div>
      <div class="img-wrapper">
        <img src="img/dosen6.png" alt="Dosen 6">
        <span class="img-name">Dr. Putu Desiana Wulaning Ayu., S.T., M.T</span>
      </div>
      <div class="img-wrapper">
        <img src="img/dosen7.png" alt="Dosen 7">
        <span class="img-name">Dr. Evi Triandini, S.P., M.Eng
        </span>
      </div>
      <div class="img-wrapper">
        <img src="img/dosen8.png" alt="Dosen 8">
