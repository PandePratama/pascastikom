...
<body>
  ...
  <div class="container text-center py-3">
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-md-6 col-sm-12 mb-3">
            <img src="/img/ajar2.jpg" class="card-img-top" style="border-radius:10px; width: 108%; height: auto;" alt="direktur">
        </div>
        <div class="col-lg-3 col-md-6 col-sm-12 mb-3">
            <img src="/img/ajar3.jpg" class="card-img-top" style="border-radius:10px; width: 108%; height: auto;" alt="direktur">
        </div>
        <div class="col-lg-3 col-md-6 col-sm-12 mb-3">
            <img src="/img/ajar4.jpg" class="card-img-top" style="border-radius:10px; width: 108%; height: auto;" alt="direktur">
        </div>
    </div>
  </div>
  ...
  <div class="container text-center py-2">
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-md-6 col-sm-12 mb-3">
            <img src="/img/LPPM2.jpg" class="card-img-top" style="border-radius:10px; width: 108%; height: auto;" alt="direktur">
        </div>
        <div class="col-lg-3 col-md-6 col-sm-12 mb-3">
            <img src="/img/LPPM3.jpg" class="card-img-top" style="border-radius:10px; width: 108%; height: auto;" alt="direktur">
        </div>
        <div class="col-lg-3 col-md-6 col-sm-12 mb-3">
            <img src="/img/LPPM4.jpg" class="card-img-top" style="border-radius:10px; width: 108%; height: auto;" alt="direktur">
        </div>
    </div>
  </div>
