                        ...
                        <div>
                            <div class="atur mr-5 mt-5">
                                ...
                                <p class="content-paragraph text-justify mx-3 mx-md-5 " style="font-size: large;">
                                    ...
                                    (praktisi pendidikan), Drs. Ida Bagus Dharmadiaksa, M.Si., Ak. (Dosen) dan Drs.
                                    Satria Dharma (praktisi pendidikan) pada tahun 2.000 yang begitu menaruh perhatian
                                    atas pesat dan dinamisnya perkembangan teknologi informasi dan komunikasi (TIK) di
                                    dunia termasuk di Indonesia dan Bali, namun di lain pihak perguruan tinggi bidang
                                    TIK sampai dengan jenjang sarjana belum ada.
                                </p>
                                <p class="content-paragraph text-justify mx-3 mx-md-5" style="font-size: large;">
                                    Maka pada tanggal 20 Mei 2001, berdirilah Yayasan Widya Dharma Shanti yang akan
                                    menjadi Badan Penyenggara Perguruan Tinggi Swasta dan selanjutnya diajukanlah ijin
                                    pendirian Institut Teknologi dan Bisnis (ITB) STIKOM Bali kepada Direktorat Jenderal
                                    Pendidikan Tinggi Kementerian Pendidikan Nasional.
                                </p>
                                <p class="content-paragraph text-justify mx-3 mx-md-5" style="font-size: large;">
                                    Dengan berbagai usaha dan lika liku pengurusan ijin serta doa, maka pada tanggal 10
                                    Agustus 2002 keluarlah ijin dimaksud dengan nomor 157/D/O/2002 dengan 2 jurusan /
                                    program studi yakni Sistem Komputer (jenjang S1) dan Manajemen Informatika (jenjang
                                    D3) lalu pada tahun 2009 ada tambahan program studi baru yakni Sistem Informasi
                                    (jenjang S1).
                                </p>
                                <br>
                            </div>
    ...
    <section id="visi-misi" class="text-light position-relative" style="background-color: #202C59; position: relative; ">
        ...
        <div class="container py-5 mt-3">
            ...
            <div class="text-center mt-4 ">
                <h1>Visi Misi Direktorat Pascasarjana</h1>
            </div>
            <br>
            <h3>Visi</h3>
            ...
            <div>
                <h3>Misi</h3>
                <p>
                    1. Menyelenggarakan kegiatan Tri Dharma Perguruan Tinggi sesuai bidang ilmu pengetahuan, teknologi,
                    dan seni. <br>
                    2. Mengembangkan Pascasarjana yang berkualitas, berdaya saing, dan unggul yang diakui secara
                    internasional. <br>
                    3. Melaksanakan hilirisasi keilmuan di lingkup Program Pascasarjana yang dapat memberikan
