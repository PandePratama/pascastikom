            ...
            @foreach($data as $media)
                <div class="col-md-6 col-lg-4 mb-1 mt-2 pr-0">
                    <div class="card" style="display: flex; flex-direction: row; align-items: flex-start; height: 17rem;">
                        <img src="{{ asset('storage/' . $media->file_path) }}" class="card-img-top img-fluid" alt="..."
                            style="width: 50%; height:auto; object-fit:cover;">
                        <div class="card-body"
                            style="display:flex; flex-direction:column; justify-content:center;width:50%; padding:0;">
