            ...
            <div class="col-sm-4 d-flex align-items-center justify-content-center">
                <div class="card-borderless" style="width: 25rem;">
                    ...
                    <div class="card-body mb-1">
                        <p class="card-text text-center"><b>Direktur Pascasarjana <br>ITB STIKOM Bali</b><br>Dr. Dandy
                            Pramana Hostiadi, S.Kom., M.T.</p>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                ...
                <table class="table table-borderless">
                    <tbody class="text-justify">
                        ...
                        <tr>
                            ...
                            <td>Menjadi pascasarjana pada bidang sistem informasi berkualitas internasional berbasis
                                intelligent dan secure system pada tahun 2030.</td>
                        </tr>
                        <tr>
                            <th scope="row">Misi</th>
                            <td>
                                <ol>
                                    <li>Menyelenggarakan pendidikan magister di bidang sistem informasi berbasis
                                        intelligent dan secure system bagi para mahasiswa agar mampu menjadi sumber daya
                                        manusia handal, unggul dan berkualitas serta diakui secara internasional guna
                                        mendukung sektor ekonomi, pariwisata, pemerintahan dan perusahaan.</li><br>
                                    <li>Menyelenggarakan penelitian dan pengembangan ilmu pengetahuan dibidang Sistem
                                        Informasi yang memberikan dampak pada kemajuan disiplin akademik dan
                                        professional internasional.</li><br>
                                    <li>Mendorong dan memfasilitasi sivitas akademika untuk melakukan pengabdian kepada
                                        masyarakat secara profesional</li>
                                </ol>
                            </td>
                        </tr>
                        <tr>
